...
get3.download_file('pfepoc', 'output/time-grid/part-00000', 'time_grid')
get3.download_file('pfepoc', 'output/npv_cube/part-00000', 'npv_cube')

#s3 = session.resource("s3")
#s3.Bucket('pfepoc').download_file('output/time-grid/part-00000', 'time_grid')
#s3.Bucket('pfepoc').download_file('output/npv_cube/part-00000', 'npv_cube')
...
response = s3_client.upload_file('simex.png', 'pfefiles', 'simex.png')
...
s3_client = boto3.client('s3')
response = s3_client.upload_file('epex.png', 'pfefiles', 'epex.png')
...
plt.savefig('pfe.png')
s3_client = boto3.client('s3')
response = s3_client.upload_file('pfe.png', 'pfefiles', 'pfe.png')
